import streamlit as st import pandas as pd import numpy as np import joblib
...
st.title("🌍 Life Expectancy Predictor") st.markdown(""" This app predicts Life Expectancy based on health, economic, and demographic indicators.

Upload your input or manually enter values to get predictions. """)

Input form

with st.form("prediction_form"): st.subheader("Enter the input values:")
